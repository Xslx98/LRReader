...
abstract class GalleryAdapterNew extends RecyclerView.Adapter<GalleryAdapterNew.GalleryHolder> {
    ...
    private final LruCache<Long, Integer> mReadProgressCache = new LruCache<>(200);
            ...
            case TYPE_LIST: {
                ...
                if (gi.pages == 0 || !AppearanceSettings.getShowGalleryPages()) {
                    ...
                    if (showReadProgress){
                        ...
                        Integer cachedProgress = mReadProgressCache.get(gi.gid);
                        if (cachedProgress != null) {
                            String text = (cachedProgress > 0 ? cachedProgress + 1 : 0) + "/" + gi.pages + "P";
