...
package com.lanraragi.framework.unifile;
...
class TreeDocumentFile extends UniFile {
    ...
    public String getName() {
        return com.lanraragi.framework.unifile.DocumentsContractApi19.getName(mContext, mUri);
    }

    @Override
    public String getType() {
        return com.lanraragi.framework.unifile.DocumentsContractApi19.getType(mContext, mUri);
    }

    @Override
    public boolean isDirectory() {
        return com.lanraragi.framework.unifile.DocumentsContractApi19.isDirectory(mContext, mUri);
    }

    @Override
    public boolean isFile() {
        return com.lanraragi.framework.unifile.DocumentsContractApi19.isFile(mContext, mUri);
    }

    @Override
    public long lastModified() {
        return com.lanraragi.framework.unifile.DocumentsContractApi19.lastModified(mContext, mUri);
    }

    @Override
    public long length() {
        return com.lanraragi.framework.unifile.DocumentsContractApi19.length(mContext, mUri);
    }

    @Override
    public boolean canRead() {
        return com.lanraragi.framework.unifile.DocumentsContractApi19.canRead(mContext, mUri);
    }

    @Override
    public boolean canWrite() {
        return com.lanraragi.framework.unifile.DocumentsContractApi19.canWrite(mContext, mUri);
    }
    ...
    public boolean delete() {
        return com.lanraragi.framework.unifile.DocumentsContractApi19.delete(mContext, mUri);
    }

    @Override
    public boolean exists() {
        return com.lanraragi.framework.unifile.DocumentsContractApi19.exists(mContext, mUri);
    }
    ...
    public UniFile findFile(String displayName) {
        Uri childUri = DocumentsContractApi21.buildChildUri(mUri, displayName);
        return com.lanraragi.framework.unifile.DocumentsContractApi19.exists(mContext, childUri) ?
