...
public abstract class UniFile {
    ...
    private static List<com.lanraragi.framework.unifile.UriHandler> sUriHandlerArray;
     ...
     */
    public static void addUriHandler(@NonNull com.lanraragi.framework.unifile.UriHandler handler) {
    ...
    public static UniFile fromFile(@Nullable File file) {
        return file != null ? new com.lanraragi.framework.unifile.RawFile(null, file) : null;
    }
    ...
    public static UniFile fromSingleUri(Context context, Uri singleUri) {
        ...
        if (version >= 19) {
            return new com.lanraragi.framework.unifile.SingleDocumentFile(null, context, singleUri);
        } else {
            return null;
        }
    }
    ...
    public static UniFile fromTreeUri(Context context, Uri treeUri) {
        final int version = Build.VERSION.SDK_INT;
        if (version >= 21) {
            return new com.lanraragi.framework.unifile.TreeDocumentFile(null, context,
    ...
    public static UniFile fromMediaUri(Context context, Uri mediaUri) {
        return new com.lanraragi.framework.unifile.MediaFile(context, mediaUri);
    }
    ...
    public static UniFile fromUri(Context context, Uri uri) {
        ...
        } else if (com.lanraragi.framework.unifile.MediaFile.isMediaUri(context, uri)) {
            return new com.lanraragi.framework.unifile.MediaFile(context, uri);
        } else {
            return null;
        }
    }
    ...
    public static boolean isDocumentUri(Context context, Uri uri) {
        final int version = Build.VERSION.SDK_INT;
        if (version >= 19) {
            return com.lanraragi.framework.unifile.DocumentsContractApi19.isDocumentUri(context, uri);
        } else {
            return false;
        }
    }
