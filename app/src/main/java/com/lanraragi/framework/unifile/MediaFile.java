...
class MediaFile extends UniFile {
    ...
    static boolean isMediaUri(Context context, Uri uri) {
        return null != com.lanraragi.framework.unifile.MediaContract.getName(context, uri);
    }
    ...
    public String getName() {
        return com.lanraragi.framework.unifile.MediaContract.getName(mContext, mUri);
    }

    @Override
    public String getType() {
        return com.lanraragi.framework.unifile.MediaContract.getType(mContext, mUri);
    }
    ...
    public long lastModified() {
        return com.lanraragi.framework.unifile.MediaContract.lastModified(mContext, mUri);
    }

    @Override
    public long length() {
        return com.lanraragi.framework.unifile.MediaContract.length(mContext, mUri);
    }
