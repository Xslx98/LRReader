...
import com.lanraragi.reader.ui.scene.gallery.detail.TankoubonDialogHelper
 ...
 * [com.lanraragi.reader.ui.scene.ListMultiSelectHelper] callbacks
...
internal class GalleryBatchOpsHelper(
    ...
    private fun onTankoubonClick() {
        ...
        TankoubonDialogHelper.pickTankoubon(
            callback.activity, callback.activeProfileId(), selected.map { it.title }
        ) { tank ->
            callback.viewModel.runBatch(
     ...
     * [com.lanraragi.reader.ui.scene.gallery.detail.DeleteArchiveHelper]: red
