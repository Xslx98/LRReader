...
class RoomMigrationV27V28Test {
    ...
    fun room_opensCleanly_afterRealUpgrade_v27_to_v28() {
        ...
        // 2) Open via Room with the migration chain -> runs MIGRATION_27_28 +
        ...
        val room = Room.databaseBuilder(ctx, AppDatabase::class.java, name)
            .addMigrations(AppDatabase.MIGRATION_27_28, AppDatabase.MIGRATION_28_29, AppDatabase.MIGRATION_29_30, AppDatabase.MIGRATION_30_31)
            .build()
        try {
