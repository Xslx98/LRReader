...
class DownloadSchedulerTest {
    ...
    fun setUp() {
        ...
        // Handler-bearing scope: see containedTestScope's KDoc (defensive
        // convergence — a fake-reaching coroutine must not poison the suite).
    ...
    fun ensureDownload_respectsConcurrencyLimit() {
        ...
        val maxConcurrent = com.lanraragi.reader.settings.DownloadSettings.getConcurrentDownloads()
        assertEquals(
