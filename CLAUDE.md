...
| [docs/audit-2026-04-15-v2.md](docs/audit-2026-04-15-v2.md) | 数据架构反模式 —— 顶部含 2026-04-26 状态更新。**W36 Phase 1 完成**：业务/UI 层零 GalleryInfo（30 commit / -556 LOC）；Phase 2（Entity 扁平化 + schema 迁移）待启动 |
