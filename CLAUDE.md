...
| [docs/audit-2026-04-15-v2.md](docs/audit-2026-04-15-v2.md) | 数据架构反模式 —— 顶部含 2026-04-26 状态更新。**W36 Phase 1 完成**（业务/UI 层零 GalleryInfo）；Phase 2（W36-7..9 Entity 扁平化）已规划，详见 [phase2 plan](docs/superpowers/plans/2026-04-26-w36-phase2-flatten-entities.md)；schema 在 W36-10 才 bump（v21→v22）做 DROP COLUMN |
