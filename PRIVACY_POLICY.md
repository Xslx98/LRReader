...
本应用**仅与**您明确配置的 LANraragi 服务器通信。不会向任何第三方服务、分析平台或广告网络发送数据。
...
| `CAMERA` | 拍照设置头像（可选，用户主动触发）/ Take photos for avatar (optional, user-initiated) |
| `FOREGROUND_SERVICE` | 后台下载档案 / Download archives in background |

## 第三方服务 | Third-Party Services

LR Reader **未集成**任何第三方分析、崩溃报告或广告 SDK。
...
源代码 / Source: [GitHub](https://github.com/<YOUR_USERNAME>/<YOUR_REPO>)
